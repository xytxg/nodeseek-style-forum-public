...
const buttonVariants = cva(
  "group/button relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-transparent px-4 py-2.5 text-sm font-semibold tracking-tight transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background selection:bg-primary/20 selection:text-primary-foreground aria-[invalid=true]:border-destructive/60 aria-[invalid=true]:focus-visible:ring-destructive/35 disabled:pointer-events-none disabled:opacity-50 transform-gpu hover:-translate-y-[1px] active:translate-y-0 active:scale-[0.99] shadow-none [@media(prefers-reduced-motion:reduce)]:transform-none [@media(prefers-reduced-motion:reduce)]:transition-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-[1.05rem] dark:aria-[invalid=true]:border-destructive/45 dark:aria-[invalid=true]:focus-visible:ring-destructive/40",
  {
    variants: {
      variant: {
        default:
